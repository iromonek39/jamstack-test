...
export default {
  ...
  methods: {
    ...
    //         if (this.brandCheckboxArr.length > 0 && this.productCheckArr.length > 0) {
    //           console.log('brand', item.brand.filter(item => this.brandCheckboxArr.includes(item)).length)
    //           console.log('products', item.products.filter(item => this.productCheckArr.includes(item)).length)
    ...
    //           item.display = false
    //         }
    //         console.log('listData.data', item)
    //       })
    //     })
    //   } else {
    //     this.listArr.forEach(listData => {
